...
def df(filepath):
    ...
    # Le o arquivo CSV para um DataFrame (Carrega os dados do CSV no DataFrame 'df')
    return pd.read_csv(filepath)

def sistema(df):

    # Exibe informacoes do DataFrame (contagem de entradas, tipos de dados e memoria ocupada)
    print("\033[00;32m\n# Informacoes de Sistema \033[00;00m")
    print(df.info())

def descricao(df):

    print(f"\033[00;32m\n# DataFrame - Dados Brutos \033[00;00m\n {df}")
...
def main(filepath):
    ...
    descricao(df(filepath)) # Exibe as estatisticas descritivas do DataFrame

# Programa
if __name__ == '__main__':

    # Funcao principal: Caminho do arquivo CSV
    main(filepath="")
