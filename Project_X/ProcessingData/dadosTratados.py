...
def arquivoNovo(df_no_zeros):
    ...
    df_no_zeros.to_csv("DataBase/dadosTratados.csv", index=False)  # Salva o DataFrame limpo em um arquivo CSV chamado 'dadosTratados.csv'
...
if __name__ == '__main__':
    main(filepath="")  # Executa a funcao principal
